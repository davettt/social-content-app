...
const CAPTION_STYLE_PROMPTS = {
  ...
  quote: 'Create an inspirational or thought-provoking quote that relates to the image. Focus on wisdom, motivation, or reflection. The quote can be original or a well-known saying that fits.',
  personal: 'Write as a genuine personal thought or reflection. Be authentic, conversational, and relatable. Share a feeling, observation, or moment of connection with the image.',
  story: 'Tell a brief story or share behind-the-scenes context. Create intrigue, share a journey, or give the audience a peek into the moment captured.',
  question: 'Craft an engaging question that invites the audience to respond. Make it thought-provoking or relatable to encourage comments and discussion.',
  announcement: 'Write in an announcement or news style. Be clear, exciting, and informative. Great for launches, updates, or sharing news.',
};
...
export async function generateCaption({
  ...
  const styleInstruction = CAPTION_STYLE_PROMPTS[captionStyle] || CAPTION_STYLE_PROMPTS.auto;
...
${businessContext && businessContext.industry ? `Context (use lightly, focus on the image):
...
export async function suggestHashtags({ caption, industry, platform = 'instagram' }) {
